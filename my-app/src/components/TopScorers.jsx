...
const TopScorers = () => {
  ...
  return (
    <div className="container mx-auto p-6">
        ...
        <p className="text-gray-700 mb-4">Total Games Played: <span className="font-bold">35</span></p>
      ...
      <h1 className="text-2xl font-bold text-center mb-6">Top 10 Scorers</h1>
